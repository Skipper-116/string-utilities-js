...
export declare function findAndReplace(str: string, find: string, replace: string): string;
...
export declare function malawiPhoneNumberValidation(phoneNumber: string): boolean;
export declare function customPhoneNumberValidation(phoneNumber: string, countryCode: string): boolean;
...
export declare function lengthCheck(str: string, min: number, max: number): boolean;
